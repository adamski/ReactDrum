...
export default class StyledScreen extends Component {
  static navigatorStyle = {
    ...
    navBarBackgroundColor: '#368912',
    navBarTextColor: '#ffff00',
    navBarSubtitleTextColor: '#ff0000',
    navBarButtonColor: '#ffffff',
    navigationBarColor: '#368912', // for Android ...

  };
  static navigatorButtons = {
    rightButtons: [{
      icon: require('../../../images/navicon_edit.png'),
      id: 'compose',
  ...
  render() {
    return (
      <ScrollView style={styles.container}>
        <Image style={{width: undefined, height: 100}} source={require('../../../images/colors.png')} />
  ...
  onSetTitleImagePress() {
    this.props.navigator.setTitle({
      title: 'title',
      titleImage: require('../../../images/one.png'),
    })
  }
